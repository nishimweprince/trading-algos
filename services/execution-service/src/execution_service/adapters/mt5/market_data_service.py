...
# The Legacy* shapes, not the canonical ones: mt5-trader's /v1/candles and
# /v1/tick have always returned epoch-int time and int volume, and the compat
# shim must keep serving exactly that.
from ta_contracts import LegacyCandle as Candle
from ta_contracts import LegacyCandlesResponse as CandlesResponse
