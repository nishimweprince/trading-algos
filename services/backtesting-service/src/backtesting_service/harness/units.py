...
def cash(weighted: float, *, dollars_per_pip_per_qty: float | None, qty_ref: float) -> float | None:
...
def conversion_factor(*, unit: str, dollars_per_pip_per_qty: float | None, qty_ref: float) -> float:
