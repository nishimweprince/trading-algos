...
from backtesting_service.comparison import COMPARISON_MODES, compare_entry_modes
...
def test_hedge_synthetic_attribution_reconciles_gross_cost_and_net() -> None:
    ...
    assert attribution.net_difference_pips == pytest.approx(hedge.net_pips - synthetic.net_pips)
