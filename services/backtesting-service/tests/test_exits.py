...
from backtesting_service.exits import time_exit_due
from backtesting_service.models import Candle, EngineParams, TimeExitMode, Timeframe
...
def test_partial_trail_initial_target_is_one_r() -> None:
    from backtesting_service.exits import initial_target_r, target_price
    from backtesting_service.models import TargetMode
