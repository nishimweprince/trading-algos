...
const PROFILES: Profile[] = [
  {
    name: 'Website',
    href: 'https://nishimweprince.dev',
    path: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20Zm7.4 9h-3.17a15.4 15.4 0 0 0-1.12-5 8.02 8.02 0 0 1 4.29 5ZM12 4.06c.9 1.13 1.6 2.9 1.96 4.94h-3.92C10.4 6.96 11.1 5.19 12 4.06ZM4.6 11a8.02 8.02 0 0 1 4.29-5 15.4 15.4 0 0 0-1.12 5H4.6Zm0 2h3.17a15.4 15.4 0 0 0 1.12 5 8.02 8.02 0 0 1-4.29-5Zm7.4 6.94c-.9-1.13-1.6-2.9-1.96-4.94h3.92c-.36 2.04-1.06 3.81-1.96 4.94ZM16.23 13h3.17a8.02 8.02 0 0 1-4.29 5 15.4 15.4 0 0 0 1.12-5Z',
  },
  {
    name: 'GitHub',
